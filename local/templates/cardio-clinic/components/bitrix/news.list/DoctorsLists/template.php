...
<section class="doctors">
    <div class="container">
                    ...
                    <li class="doctors-list__item" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
                        <a class="doctors-list__item-link" href="<?= $arItem["DETAIL_PAGE_URL"] ?>">
                            ...
                            <div class="doctors-list__item-content">
                                ...
                                <div class="doctors-list__item-btn-more btn btn__more"><?= Loc::getMessage("DETAIL") ?></div>
                            </div>
                        </a>
                    </li>
                <? endforeach; ?>
        ...
        <? endif; ?>
        <a class="doctors__btn btn btn__primary" href="javascript:;"><?= Loc::getMessage("VIEW_ALL") ?>(<?= $arResult['SPECIALISTS_COUNT'] ?>)</a>
    </div>
</section>
